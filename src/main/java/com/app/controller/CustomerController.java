...
//		System.out.println("in search locations....");
//		map.addAttribute("locations_list",dao.getShopsLocations());
//		map.addAttribute("areas_list",dao.getShopsAreas());  
//		return "/customers/selectlocation";
//	}
//	
//
//	@PostMapping("/selectshop")
//	public String searchShopsByLocation(Model map,@RequestParam String areas,String locations,RedirectAttributes flashmap,HttpSession hs) 
//	{
//		System.out.println("in in search shops....");
//	//	flashmap.addAttribute("shop_locations",locations);
//	//	flashmap.addAttribute("shops_areas",areas);
//		hs.setAttribute("Shop_locations",locations);
//		hs.setAttribute("Shop_areas",areas);
//		map.addAttribute("Shops_list",dao.getShopsByAreas(areas));
//		return "/customers/selectshop";
//	}
	@GetMapping("/details")
	public String searchdetails(Model map) {
		
		return "/customers/details";
	}
	
	@GetMapping("/Home_Service")
	public String searchHome_Service(Model map) {
		
		return "/customers/secpage";
	}
	@GetMapping("/Salon_Service")
	public String searchSalon_Service(Model map) {
		
		return "/customers/secpage";
	}
	
	@GetMapping("/secpage")
	public String searchsecpage(Model map) {
	...
	@GetMapping("/selectprofilecust")
	public String searchselectprofile(Model map,HttpSession hs,@RequestParam int userId) {
		System.out.println("in search profile....");
	    hs.setAttribute("userId",userId);
		map.addAttribute("user_dtls",dao.getUserByuserId(userId)); 
		return "/customers/selectprofilecust";
	}
	
	
	@PostMapping("/selectshop")
	public String searchShopsByLocation(Model map,@RequestParam String locations,RedirectAttributes flashmap,HttpSession hs) 
	{
		System.out.println("in in search shops....");
		//flashmap.addAttribute("shop_location",location);
		hs.setAttribute("shop_locations",locations);
		map.addAttribute("shops_list",dao.getShopsByLocations(locations));
		return "/customers/selectshop";
	}
	...
	public String bookAppointConfirm(Model map,HttpSession hs,RedirectAttributes flashmap)
	{
		...
		//add services to appointments object
		List<Services> serv= (List<Services>) hs.getAttribute("serv");
